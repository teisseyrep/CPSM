...
n_seq = np.array([250,500,750,1000,1250,1500,1750,2000,2250,2500])
n_sym = 30
...
for method in method_seq:
    ...
    res_bacc = np.zeros((n_sym,len(n_seq)))
    res_bacc1 = np.zeros((n_sym,len(n_seq)))
    res_acc = np.zeros((n_sym,len(n_seq)))
    res_error = np.zeros((n_sym,len(n_seq)))
    res_time = np.zeros((n_sym,len(n_seq)))
    ...
    np.savetxt('results_artificial/exp2_acc_' + method  + '_' + ds + '_k' + str(k) + '_p' + str(p) + '_pz' + str(pz) + '_pip' + str(pi_p) + '_piq' + str(pi_q) +  '.txt', res_acc, fmt='%1.3f')
    np.savetxt('results_artificial/exp2_bacc_' + method  + '_' + ds + '_k' + str(k) + '_p' + str(p) + '_pz' + str(pz) + '_pip' + str(pi_p) + '_piq' + str(pi_q) +  '.txt', res_bacc, fmt='%1.3f')
    np.savetxt('results_artificial/exp2_bacc1_' + method  + '_' + ds + '_k' + str(k) + '_p' + str(p) + '_pz' + str(pz) + '_pip' + str(pi_p) + '_piq' + str(pi_q) +  '.txt', res_bacc1, fmt='%1.3f')
    np.savetxt('results_artificial/exp2_error_' + method  + '_' + ds + '_k' + str(k) + '_p' + str(p) + '_pz' + str(pz) + '_pip' + str(pi_p) + '_piq' + str(pi_q) +  '.txt', res_error, fmt='%1.3f')
    np.savetxt('results_artificial/exp2_time_' + method  + '_' + ds + '_k' + str(k) + '_p' + str(p) + '_pz' + str(pz) + '_pip' + str(pi_p) + '_piq' + str(pi_q) +  '.txt', res_time, fmt='%1.3f')
